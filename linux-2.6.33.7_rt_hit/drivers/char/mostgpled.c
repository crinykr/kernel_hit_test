...
#if defined(CONFIG_MODEL_RKSII_CI)      || defined(CONFIG_MODEL_RKSII_VR) || defined(CONFIG_MODEL_RKSII_VR_FEMALE) || \
    defined(CONFIG_MODEL_RKSII_VR_MALE) || defined(CONFIG_MODEL_RKN)
...
{
#if defined(CONFIG_MODEL_RKSII_CI)        || defined(CONFIG_MODEL_RKSII_VR) || \
	defined(CONFIG_MODEL_RKSII_VR_FEMALE) || defined(CONFIG_MODEL_RKSII_VR_MALE) || \
	defined(CONFIG_MODEL_RKN)
...
#if defined(CONFIG_MODEL_RKSII_VI)  || defined(CONFIG_MODEL_RK_HIT_V2) || \
    defined(CONFIG_MODEL_RK_HIT_V4) || defined(CONFIG_MODEL_RK_HIT_OV7675) || \
    defined(CONFIG_MODEL_RK_HIT_L)  || defined(CONFIG_MODEL_RK_HIT_VI) || \
    defined(CONFIG_MODEL_RK_HIT_N)
int display(int val)
{

#if defined(CONFIG_MODEL_RK_HIT_N)
#define SUPERNOVA_RESET_MASK	(0x01 << 5)

    int led;

    led = base->GPIOxOUT & ~SUPERNOVA_RESET_MASK;

    led |= (val & SUPERNOVA_RESET_MASK);

    base->GPIOxOUT = led;
#endif
	return 0;
}
#elif defined(CONFIG_MODEL_RKSII_CI)        || defined(CONFIG_MODEL_RKSII_VR)      || \
      defined(CONFIG_MODEL_RKSII_VR_FEMALE) || defined(CONFIG_MODEL_RKSII_VR_MALE) || \
      defined(CONFIG_MODEL_RKN)             || defined(CONFIG_MODEL_AE_AUDIO2)     || \
      defined(CONFIG_MODEL_RK_HIT_SUPERNOVA)
#define CAMERA_RESET_MASK	(0x01 << 28)
int display(int val)
{
    int led;

    led = base->GPIOxOUT & (0xFF000000 | CAMERA_RESET_MASK);
#if !(defined(CONFIG_MODEL_AE_AUDIO2) || defined(CONFIG_MODEL_RK_HIT_SUPERNOVA))
    if (val & 0x80000)
    	led |= val & 0x1F7FFFF;
    else
    	led |= (val & 0x1F7FFFF) | 0x80000;
#else
	led |= (val & 0xFFFFFF & ~CAMERA_RESET_MASK);
#endif // CONFIG_MODEL_AE_AUDIO2
...
#else // CONFIG_MODEL_RKSII_CI || CONFIG_MODEL_RKSII_VR || CONFIG_MODEL_RKSII_VR_FEMALE || CONFIG_MODEL_RKSII_VR_MALE || CONFIG_MODEL_RKN
  #error "Model name CONFIG_MODEL_???? must be defined!"
#endif	// CONFIG_MODEL_RKSII_VI || CONFIG_MODEL_RK_HIT_V2 || CONFIG_MODEL_RK_HIT_V4 || CONFIG_MODEL_RK_HIT_OV7675 || CONFIG_MODEL_RK_HIT_L || CONFIG_MODEL_RK_HIT_VI
...
#if defined(CONFIG_SND_NEXELL_SOC_AC97) || defined(CONFIG_MODEL_RKSII_CI) || defined(CONFIG_MODEL_RKSII_VR) || \
	defined(CONFIG_MODEL_RKSII_VR_FEMALE) || defined(CONFIG_MODEL_RKSII_VR_MALE) || defined(CONFIG_MODEL_RKN)

#if !defined(CONFIG_MODEL_AE_AUDIO2)
    base->GPIOxOUTENB |= 0xFFFFFFF;
#endif
    base->GPIOxOUT = 0x00000;
//#else
//    base->GPIOxOUT = 0xFFFFF;
#elif defined(CONFIG_MODEL_RK_HIT_SUPERNOVA)
	base->GPIOxOUT = 0x800000;
#elif defined(CONFIG_MODEL_RK_HIT_N)
#endif
