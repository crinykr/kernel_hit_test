...
#define reg_read(reg, val) hi161_read_reg(client, HI_161_##reg, val)
#define reg_write(reg, val) hi161_write_reg(client, HI_161_##reg, (val))
#define reg_set(reg, val) hi161_reg_set(client, HI_161_##reg, (val))
#define reg_clear(reg, val) hi161_reg_clear(client, HI_161_##reg, (val))
