...
static int ov7675_set_power_save(struct i2c_client *client, int val)
{
	return 0;
}
...
static int ov7675_command(struct i2c_client *client, u32 cmd, void *arg)
{
	...
	case I2C_CAM_POWER_SAVE:
		ov7675_set_power_save(client, (int) arg);
		break;
...
static int ov7675_driver_resume(struct i2c_client *client)
{
	struct v4l2_subdev *sd = i2c_get_clientdata(client);
	struct nx_vip_camera *cam = to_vip_cam(sd);
	...
	ov7675_reset(sd, 0);
    ov7675_start(client);
    ov7675_set_brightness(client, cam->cur_gain);

    return 0;
}

static int ov7675_i2c_driver_resume(struct i2c_client *client)
{
	struct v4l2_subdev *sd = i2c_get_clientdata(client);
	struct nx_vip_camera *cam = to_vip_cam(sd);
...
static struct i2c_driver ov7675_i2c_driver = {
	.driver = {
		.name = "OV7675",
		.owner = THIS_MODULE,
		.resume = ov7675_driver_resume,
	},
	.id_table     = ov7675_id,
	.probe        = ov7675_probe,
	.resume       = ov7675_i2c_driver_resume,
