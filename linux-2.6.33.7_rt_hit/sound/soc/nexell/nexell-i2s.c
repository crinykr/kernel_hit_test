...
#define NXP2120_AUDIO_BUFF_CONFIG_PI_WIDTH_18   (1 << 4)
#define NXP2120_AUDIO_BUFF_CONFIG_PI_WIDTH_20   (2 << 4)
#define NXP2120_AUDIO_BUFF_CONFIG_PI_WIDTH_24   (3 << 4)
#define NXP2120_AUDIO_BUFF_CONFIG_SP_WIDTH_MASK (3 << 2)
#define NXP2120_AUDIO_BUFF_CONFIG_SP_WIDTH_16   (0 << 2)
#define NXP2120_AUDIO_BUFF_CONFIG_SP_WIDTH_18   (1 << 2)
#define NXP2120_AUDIO_BUFF_CONFIG_SP_WIDTH_20   (2 << 2)
#define NXP2120_AUDIO_BUFF_CONFIG_PO_WIDTH_MASK (3 << 0)
#define NXP2120_AUDIO_BUFF_CONFIG_PO_WIDTH_16   (0 << 0)
#define NXP2120_AUDIO_BUFF_CONFIG_PO_WIDTH_18   (1 << 0)
#define NXP2120_AUDIO_BUFF_CONFIG_PO_WIDTH_20   (2 << 0)
#define NXP2120_AUDIO_BUFF_CONFIG_PO_WIDTH_24   (3 << 0)
...
static int start_nx_i2s(struct snd_pcm_substream *substream)
{
	...
	if (SNDRV_PCM_STREAM_PLAYBACK == substream->stream) {
		reg = i2s_reg->AUDIO_BUFF_CTRL;
		reg |= NXP2120_AUDIO_BUFF_CTRL_PCMOBUF_EN; /* PCMOUT buffer enable */
	    i2s_reg->AUDIO_BUFF_CTRL = reg;
	    reg = i2s_reg->I2S_CONFIG;
	    reg |= NXP2120_I2S_CONFIG_I2S_OUT_EN; /* I2S Out Enable */
	    i2s_reg->I2S_CONFIG = reg; 
	    //i2s_reg->AC97_CONFIG |= 1;
	} else {
		reg = i2s_reg->AUDIO_BUFF_CTRL;
		reg |= NXP2120_AUDIO_BUFF_CTRL_PCMIBUF_EN; /* PCMIN buffer enable */
	    i2s_reg->AUDIO_BUFF_CTRL = reg;
	    reg = i2s_reg->I2S_CONFIG;
	    reg |= NXP2120_I2S_CONFIG_I2S_IN_EN; /* I2S IN Enable */
	    i2s_reg->I2S_CONFIG = reg;
/*
...
static void stop_nx_i2s(struct snd_pcm_substream *substream)
{
	...
	if (SNDRV_PCM_STREAM_PLAYBACK == substream->stream) {
		reg = i2s_reg->AUDIO_BUFF_CTRL;
		reg &= ~NXP2120_AUDIO_BUFF_CTRL_PCMOBUF_EN;   /* PCMOUT buffer disable */
		i2s_reg->AUDIO_BUFF_CTRL = reg;
		reg = i2s_reg->I2S_CONFIG;
		reg &= ~NXP2120_I2S_CONFIG_I2S_OUT_EN; /* I2S Out Disable */
		i2s_reg->I2S_CONFIG = reg; 
	} else {
		reg = i2s_reg->AUDIO_BUFF_CTRL;
		reg &= ~NXP2120_AUDIO_BUFF_CTRL_PCMIBUF_EN;   /* PCMIN buffer disable */
		i2s_reg->AUDIO_BUFF_CTRL = reg;
		reg = i2s_reg->I2S_CONFIG;
		reg &= ~NXP2120_I2S_CONFIG_I2S_IN_EN; /* I2S In Disable */
		i2s_reg->I2S_CONFIG = reg; 
	}
...
static int nx_i2s_ops_hw_params(struct snd_pcm_substream *substream, struct snd_pcm_hw_params *params, struct snd_soc_dai *dai)
{
	...
	case SNDRV_PCM_FORMAT_S16_LE:
		val = i2s_reg->AUDIO_BUFF_CONFIG;
		if (SNDRV_PCM_STREAM_PLAYBACK == substream->stream) {			
			val &= ~NXP2120_AUDIO_BUFF_CONFIG_PO_WIDTH_MASK;
			val |= NXP2120_AUDIO_BUFF_CONFIG_PO_WIDTH_16;
		} else {
			val &= ~NXP2120_AUDIO_BUFF_CONFIG_PI_WIDTH_MASK;
			val |= NXP2120_AUDIO_BUFF_CONFIG_PI_WIDTH_16;
		}
		i2s_reg->AUDIO_BUFF_CONFIG = val;
		rtd->dma_width = 2;
		break;
	...
	case SNDRV_PCM_FORMAT_S32_LE:
		...
		if (SNDRV_PCM_STREAM_PLAYBACK == substream->stream) {			
			val &= ~NXP2120_AUDIO_BUFF_CONFIG_PO_WIDTH_MASK;
			val |= NXP2120_AUDIO_BUFF_CONFIG_PO_WIDTH_24;
		} else {
			val &= ~NXP2120_AUDIO_BUFF_CONFIG_PI_WIDTH_MASK;
			val |= NXP2120_AUDIO_BUFF_CONFIG_PI_WIDTH_24;
		}
		i2s_reg->AUDIO_BUFF_CONFIG = val;
		rtd->dma_width = 4;
		break;
	...
	printk("i2s_audio_buf_config = %x\n", i2s_reg->AUDIO_BUFF_CONFIG);
	return 0;
}
...
#define NX_I2S_FORMATS (SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE | SNDRV_PCM_FMTBIT_S32_LE)
