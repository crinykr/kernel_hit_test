...
#include "../codecs/cx2074x_cx20865.h"
...
static struct snd_soc_dai_link most2120_dai_link = {
	.name 			= "ST Maui+SuperNova",
	.stream_name 	= "ST Maui+SuperNova HiFi",
	.codec_dai 		= &soc_codec_cx2074x_cx20865_dai,	/* codecs cx2074x */
...
static struct snd_soc_device cx2074x_soc_device = {
	...
	.codec_dev 	= &soc_codec_dev_cx2074x_cx20865,		/* codecs/cx2074x */
...
static int __init cx2074x_cx20865_modinit(void)
{
...
module_init(cx2074x_cx20865_modinit);
module_exit(most2120_exit);

MODULE_AUTHOR("Seungwoo Kim <ksw@mostitech.com>");
MODULE_DESCRIPTION("Sound codec-cx2074x driver for most2120 board");
MODULE_LICENSE("GPL");
