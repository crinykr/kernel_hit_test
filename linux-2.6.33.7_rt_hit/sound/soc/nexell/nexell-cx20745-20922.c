...
#include "../codecs/cx2074x_cx20922.h"
...
static int most2120_cx2074x_init(struct snd_soc_codec *codec)
{
    u16 iface;
	DBGOUT("%s\n", __func__);
...
static struct snd_soc_dai_link most2120_dai_link = {
	.name 			= "STcube Maui+BigBang",
	.stream_name 	= "STcube Maui+BigBang HiFi",
	.codec_dai 		= &soc_codec_cx2074x_cx20922_dai,	/* codecs cx2074x/cx20922 */
	.cpu_dai 		= &nx_snd_i2s_dai,			/* nexell-i2s */
	.init           = most2120_cx2074x_init,
	.ops 			= &most2120_codec_ops,
};

static struct snd_soc_card most2120_cx2074x_card = {
	.name 		= "STCUBE Maui+BigBang",
...
static struct snd_soc_device cx2074x_soc_device = {
	.card 		= &most2120_cx2074x_card,
	.codec_dev 	= &soc_codec_dev_cx2074x_cx20922,		/* codecs/cx2074x/cx20922 */
...
static int __init cx2074x_cx20922_modinit(void)
{
...
module_init(cx2074x_cx20922_modinit);
module_exit(most2120_exit);

MODULE_AUTHOR("Seungwoo Kim <ksw@mostitech.com>");
MODULE_DESCRIPTION("Sound codec-cx2074x/cx20922 driver for most2120 board");
MODULE_LICENSE("GPL");
